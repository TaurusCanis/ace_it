"""
Django settings for ace_it project.
...
WSGI_APPLICATION = 'ace_it.wsgi.application'
...
STATIC_URL = os.path.join(BASE_DIR, 'ace_it_test_prep/static/')
# STATIC_URL = '/static/'
